(() => {
  ...
  var exist = (elementOrArray) => {
    if (!elementOrArray && elementOrArray !== 0)
      return false;
  ...
  var header = () => {
    ...
    window.addEventListener("load", () => {
      ...
      $wrapper?.style.setProperty("--height-header", `${headerHeight}px`);
    });
  ...
  var R = class extends g {
    ...
    constructor(t2, e2 = {}, i2 = {}) {
      ...
      this.container = t2, this.initContent(), this.attachPlugins(Object.assign(Object.assign({}, R.Plugins), i2)), this.emit("attachPlugins"), this.emit("init");
  ...
  var K = class extends g {
    ...
    processOptions() {
      var t2, e2;
      const i2 = u({}, K.defaults, this.userOptions);
      let n2 = "";
  ...
  var rt = class extends B {
    ...
    onClose() {
      if (this.timer && clearTimeout(this.timer), true !== rt.hasSilentClose)
        try {
    ...
    static startFromUrl() {
      if (rt.hasSilentClose = false, ce.getInstance() || false === ce.defaults.Hash)
        return;
      const { hash: t2, slug: e2, index: i2 } = rt.parseURL();
      if (!e2)
        return;
  ...
  var ce = class extends g {
    ...
    init() {
      if (this.state === st.Destroy)
        return;
      this.state = st.Init, this.attachPlugins(Object.assign(Object.assign({}, ce.Plugins), this.userPlugins)), this.emit("init"), this.emit("attachPlugins"), true === this.option("hideScrollbar") && (() => {
        if (!Q)
          return;
    ...
    static fromEvent(t2) {
      ...
      if ((!e2 || d2 || c2) && (r2 = [].slice.call(n2.querySelectorAll(s2))), e2 && !c2 && (r2 = d2 ? r2.filter((t3) => t3.getAttribute(`${h2}`) === d2) : [e2]), !r2.length)
        return;
      const f2 = ce.getInstance();
      return f2 && f2.options.triggerEl && r2.indexOf(f2.options.triggerEl) > -1 ? void 0 : (e2 && (l2.startIndex = r2.indexOf(e2)), ce.fromNodes(r2, l2));
    }
  ...
  var about_default = about = () => {
    const $section_title = document.querySelector(".main_about__title");
    const $triggers = $section_title?.querySelectorAll("a");
